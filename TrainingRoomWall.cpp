...
// マクロ定義
//*****************************************************************************
constexpr	int MAX_MESH_TR_WALL = 4;									// 壁の総数
...
static float wallSize = 500.0f;	//サイズ

static Vector3 g_position[MAX_MESH_TR_WALL] = {
	{0,0,wallSize / 2},
	{-wallSize / 2,0,0},
	{wallSize / 2,0,0},
	{0,0,-wallSize / 2}
...
static Vector3 g_rotation[MAX_MESH_TR_WALL] = {
	{0,0,180},
	{180,90.0f,0},
	{180,-90.0f,0},
	{0,180.0f,180}
...
void InitTR_Wall() {
	...
	bool sts = CreateSRVfromFile("assets/texture/1149351.jpg", dev, devcontext, &g_srv);
	if (!sts) {
